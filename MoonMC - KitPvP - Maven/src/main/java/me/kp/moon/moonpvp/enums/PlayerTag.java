...
public enum PlayerTag {
    ...
    BUILDER("BUILDER", "l", "§2§lBuilder §2", ChatColor.DARK_GREEN, 12),
    TRIAL("TRIAL", "k", "§d§lTrial §d", ChatColor.LIGHT_PURPLE, 11),
    MOD("MOD", "j", "§5§lMod §5", ChatColor.DARK_PURPLE, 10),
    MODGC("MODGC", "i", "§5§lModGC §5", ChatColor.DARK_PURPLE, 9),
    MODPLUS("MODPLUS", "h", "§5§lMod+ §5", ChatColor.DARK_PURPLE, 8),
