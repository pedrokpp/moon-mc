...
//            }
            ...
            PlayerUtils.sendMessageToStaff(" \n" +
                    "  §c§lALERTA DE REPORT " +
                    "\n§fReportado: §c" + target.getName() + fakeT +  " §7(" + PlayerUtils.getPlayerPing(target) + "ms | " + kitTarget + "§7)" +
                    "\n§fMotivo: §a" + report +
                    "\n§fAutor: §a" + player.getName() + fake + " §7(" + PlayerUtils.getPlayerPing(player) + "ms | " + kitPlayer + "§7)");
